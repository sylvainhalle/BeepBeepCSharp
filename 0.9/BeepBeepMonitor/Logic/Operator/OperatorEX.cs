...
/**
 * The EX operator implements the functionalities of the CTL EX temporal
 * modality.
 * 
 * @author Sylvain Hallé
 * @version 2008-05-23
 */
public class OperatorEX : UnaryOperator
{
    private static string symbol = "EX";

    public OperatorEX() : base()
    {
        m_symbol = OperatorEX.symbol;
    }

    public OperatorEX(Operator o) : base(o)
    {
        m_symbol = OperatorEX.symbol;
    }
    ...
    {
        return new OperatorAX(m_operand.getNegated());
    }
    ...
    {
        UnaryOperator o = new OperatorEX();
