...
/**
 * The EV operator implements the functionalities of the CTL EV temporal
 * modality. EV is the dual of EU.
 * 
 * @author Sylvain Hallé
 * @version 2008-05-23
 */
public class OperatorEV : BinaryOperator
{
    ...
    public OperatorEV() : base()
    {
        m_symbol = OperatorEV.symbol;
        m_symbolLeft = OperatorEV.symbolLeft;
    }

    public OperatorEV(Operator o1, Operator o2) : base(o1, o2)
    {
        m_symbol = OperatorEV.symbol;
        m_symbolLeft = OperatorEV.symbolLeft;
    }
    ...
    {
        return new OperatorAU(m_left.getNegated(), m_right.getNegated());
    }
