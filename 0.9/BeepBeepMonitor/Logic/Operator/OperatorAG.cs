 ...
 * @version 2008-05-23
 */
public class OperatorAG : UnaryOperator
{
    private static string symbol = "AG";

    public OperatorAG() : base()
    {
        m_symbol = OperatorAG.symbol;
    }

    public OperatorAG(Operator o) : base(o)
    {
        m_symbol = OperatorAG.symbol;
    }
    ...
    {
        return new OperatorEF(m_operand.getNegated());
    }
    ...
    {
        UnaryOperator o = new OperatorAG();
