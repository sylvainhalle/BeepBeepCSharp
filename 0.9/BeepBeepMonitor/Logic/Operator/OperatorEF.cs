...
/**
 * The EF operator implements the functionalities of the CTL EF temporal
 * modality.
 * 
 * @author Sylvain Hallé
 * @version 2008-05-23
 */
public class OperatorEF : UnaryOperator
{
    private static string symbol = "EF";

    public OperatorEF() : base()
    {
        m_symbol = OperatorEF.symbol;
    }

    public OperatorEF(Operator o) : base(o)
    {
        m_symbol = OperatorEF.symbol;
    }
    ...
    {
        return new OperatorAG(m_operand.getNegated());
    }
    ...
    {
        UnaryOperator o = new OperatorEF();
