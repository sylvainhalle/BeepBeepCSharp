 ...
 * @version 2008-05-23
 */
public class OperatorAU : BinaryOperator
{
    ...
    public OperatorAU() : base()
    {
        m_symbol = OperatorAU.symbol;
        m_symbolLeft = OperatorAU.symbolLeft;
    }

    public OperatorAU(Operator o1, Operator o2) : base(o1, o2)
    {
        m_symbol = OperatorAU.symbol;
        m_symbolLeft = OperatorAU.symbolLeft;
    }
    ...
    {
        return new OperatorEV(m_left.getNegated(), m_right.getNegated());
    }
    ...
    {
        BinaryOperator o = new OperatorAU();
