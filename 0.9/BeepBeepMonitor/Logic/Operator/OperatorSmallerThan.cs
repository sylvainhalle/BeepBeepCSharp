...
/**
 * The SmallerThan operator implements the functionalities of the &lt; operator.
 ...
 * @version 2008-12-23
 */
public class OperatorSmallerThan : BinaryOperator
{
	private static string symbol = "<";
	private static string symbolUnicode = "<";

    /**
     * If set to true, the comparison includes equality (i.e. it is a "smaller
     ...
     */
	public OperatorSmallerThan(Operator left, Operator right) : base(left, right)
	{
		m_symbol = OperatorSmallerThan.symbol;
		m_unicodeSymbol= symbolUnicode;
	}
	
	public OperatorSmallerThan(Operator left, Operator right, bool inconclusive) : this(left, right)
	{
		m_inclusive = true;
		m_symbol = OperatorSmallerThan.symbol + "=";
		m_unicodeSymbol = symbolUnicode + "=";
     ...
     * <p>
     * In the case of a SmallerThan operator, evaluates both sides of the
	...
	public override Operator evaluate(Atom variable, Operator val)
	{
		...
		return new OperatorSmallerThan(leftPart, rightPart);
	}
