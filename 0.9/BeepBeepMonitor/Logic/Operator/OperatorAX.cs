...
/**
 * The AX operator implements the functionalities of the CTL AX temporal
 * modality.
 * 
 * @author Sylvain Hallé
 * @version 2008-05-23
 */
public class OperatorAX : UnaryOperator
{
    private static string symbol = "AX";

    public OperatorAX() : base()
    {
        m_symbol = OperatorAX.symbol;
    }

    public OperatorAX(Operator o) : base(o)
    {
        m_symbol = OperatorAX.symbol;
    }
    ...
    {
        return new OperatorEX(m_operand.getNegated());
    }
    ...
    {
        UnaryOperator o = new OperatorAX();
